...
| Scans for a deterministic dedupe key before every write — relationship file and CRM alike — and stamps every touchpoint entry and typed record with a provenance suffix (producer, evidence, timestamp) | The agent patterns Fulcra publishes in [fulcra-for-agents](https://github.com/kubla/fulcra-for-agents): repetition tolerance, derived context |
